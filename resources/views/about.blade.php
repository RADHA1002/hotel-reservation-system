			...
			<div class="uk-container">
				...
				<div class="" data-uk-grid>
					<div class="uk-width-3-5@xl uk-width-3-5@l uk-width-1-1@m">
						<!-- text content -->
						<h2 class="uk-margin-remove">Milky Network</h2>
				...
				<ul class="uk-child-width-1-4@xl uk-child-width-1-4@l uk-child-width-1-2@m uk-child-width-1-2@s history-list" data-uk-grid>
					<li class="uk-padding-large uk-padding-remove-vertical">
						...
						<div class="uk-position-relative impx-history-item">
							...
							<p class="uk-margin-remove impx-text-large impx-text-light">Foundation of the Original Estate</p>
							<p class="uk-margin-remove-bottom impx-text-lighter">The property began as a countryside estate built by British settlers, known for its grand architecture and serene surroundings. It quickly became a retreat for travelers seeking peace and fresh air.</p>
						</div>
					</li>
					...
					<li class="uk-padding-large uk-padding-remove-vertical">
						...
						<div class="uk-position-relative impx-history-item">
							...
							<p class="uk-margin-remove impx-text-large impx-text-light">Converted into a Guest House</p>
							<p class="uk-margin-remove-bottom impx-text-lighter">After World War I, the estate was transformed into a charming guest house welcoming diplomats and artists. It became known for its tea garden and panoramic hill views.</p>
						</div>
					</li>
					...
					<li class="uk-padding-large uk-padding-remove-vertical">
						...
						<div class="uk-position-relative impx-history-item">
							...
							<p class="uk-margin-remove impx-text-large impx-text-light">Modern Renovation and Expansion</p>
							<p class="uk-margin-remove-bottom impx-text-lighter">Significant renovation added modern amenities while preserving historical charm. The guest house expanded into a boutique hotel with 30 rooms, a fine dining restaurant, and a wellness spa.</p>
						</div>
					</li>
					...
					<li class="uk-padding-large uk-padding-remove-vertical">
						...
						<div class="uk-position-relative impx-history-item">
							...
							<p class="uk-margin-remove impx-text-large impx-text-light">Luxury Redefined</p>
							<p class="uk-margin-remove-bottom impx-text-lighter">Now a five-star destination, the hotel blends heritage with luxury. With eco-friendly practices, digital bookings, and award-winning service, it attracts guests from around the world.</p>
						</div>
					</li>
							...
							<form class="uk-grid-margin-small uk-child-width-1-6@xl uk-child-width-1-6@l uk-child-width-1-6@m uk-child-width-1-3@s" data-uk-grid>
								<div class="uk-form-controls">
								    <div class="uk-inline">
								        ...
								        <input class="uk-input booking-email uk-border-rounded" type="text" placeholder="your Email">
								    </div>
							    </div>
							    <div class="uk-form-controls">
								    <div class="uk-inline">
